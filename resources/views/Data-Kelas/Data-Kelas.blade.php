<x-layout.app>
        ...
        <tbody>
            @foreach ($class as $item)
                <tr>
                    ...
                    <td><button data-bs-target="#modalubah-{{ $item->id }}" data-bs-toggle="modal">ubah</button>
                    </td>
                    <td><button data-bs-target="#modalhapus-{{ $item->id }}" data-bs-toggle="modal">Hapus</button>
                    </td>
                    <td><button data-bs-target="#modalimport-{{ $item->id }}" data-bs-toggle="modal">import</button>
                    </td>
                    <td><button data-bs-target="#modalexport-{{ $item->id }}" data-bs-toggle="modal">export</button>
                    </td>
                </tr>
            @endforeach
    ...
    @foreach ($class as $item1)
        <div class="modal fade" id="modalimport-{{ $item1->id }}" data-bs-backdrop="static"
            data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h1 class="modal-title fs-5" id="staticBackdropLabel">Create Data Siswa</h1>
                    ...
                    <div class="modal-body">
                        <form action="{{ route('import.excel') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                        <div>
                                <input type="hidden" name="kelas_id" value="{{ $item1->id }}">
                                <span>{{ $item1->Nama_Kelas }}</span>
                        </div>
                        <br>
                        <div >
    ...
    @foreach ($class as $item1)
    <div class="modal fade" id="modalexport-{{ $item1->id }}" data-bs-backdrop="static"
        data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    ...
                    <div>
                            <input type="hidden" name="kelas_id" value="{{ $item1->id }}">
                            <span> yakin esxport {{ $item1->Nama_Kelas }}?</span>
                    </div>
                    <br>
    ...
    {{-- endmodalimport --}}
        ...
        <!-- Modal -->
        @foreach ($class as $item1)
            <div class="modal fade" id="staticBackdrop-{{ $item1->id }}" data-bs-backdrop="static"
                data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
        ...
        {{-- modaltambah --}}
        <button type="button" class="btn btn-success" data-bs-target="#modaltambah" data-bs-toggle="modal">Tambah
            +</button>
                    ...
                    <div class="modal-body">
                        <form action="tambahkelas" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input type="Nama" name="Nama_Kelas" class="form-control" id="exampleInputNama"
                                    placeholder="Nama">
                            </div>
                            <div class="form-group">
        ...
        @foreach ($class as $ubah)
            ...
            <div class="modal fade" id="modalubah-{{ $ubah->id }}" tabindex="-1"
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form action="{{ url('/editkelas/' . $ubah->id) }}" method="POST"
                                enctype="multipart/form-data">
                                @csrf
                                <div class="form-group">
                                    <label for="exampleInputPassword1">Nama Kelas</label>
                                    <input type="Nama" name="Nama_Kelas" class="form-control"
                                        id="exampleInputNama" placeholder="Nama" value="{{ $ubah->Nama_Kelas }}">
                                </div>
                                {{-- <div class="form-group">
                        <label for="exampleInputPassword1">Jurusan</label>
